/*  Robert Kety
    ...
    Description: Implement input file loading and concordance for this hash map
                 test function. */
...
int main (int argc, const char * argv[]) {
    ...
    currWord = getWord(fileptr);
    while(currWord != 0){
        wordCount = atMap(hashTable, currWord);
        insertMap(hashTable, currWord, (ValueType) (wordCount + 1));
        currWord = getWord(fileptr);
    }
